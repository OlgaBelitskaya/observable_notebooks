...
md`## Loading Images`
  ...
  main.variable(observer("width_img")).define("width_img", function(){return(
64
)});
  main.variable(observer("height_img")).define("height_img", function(){return(
64
)});
  main.variable(observer("topK")).define("topK", function(){return(
5
)});
  main.variable(observer("getImg")).define("getImg", ["width_img","height_img"], function(width_img,height_img){return(
function(file) {
  const img=new Promise((resolve,reject)=>{
  let image=new Image();
  image.onload=()=>resolve(image); image.onerror=reject;
  image.crossOrigin='anonymous';
  image.src='https://olgabelitskaya.gitlab.io/images/'.concat(file);
  image.width=width_img; image.height=height_img;})
  return img; }
)});
  main.variable(observer("img0")).define("img0", ["getImg"], function(getImg){return(
getImg('04_001.png')
)});
  main.variable(observer("img1")).define("img1", ["getImg"], function(getImg){return(
getImg('04_002.png')
)});
  main.variable(observer("img2")).define("img2", ["getImg"], function(getImg){return(
getImg('04_003.png')
)});
  main.variable(observer()).define(["md"], function(md){return(
md`## Images2Tensors`
)});
  main.variable(observer("tensor0")).define("tensor0", ["tf","img0"], function(tf,img0){return(
tf.browser.fromPixels(img0)
)});
  main.variable(observer("tensor1")).define("tensor1", ["tf","img1"], function(tf,img1){return(
tf.browser.fromPixels(img1)
)});
  main.variable(observer("tensor2")).define("tensor2", ["tf","img2"], function(tf,img2){return(
tf.browser.fromPixels(img2)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`## Tensors2Images`
)});
  main.variable(observer("createImg")).define("createImg", ["DOM"], function(DOM){return(
function(tensor) {
  ...
  main.variable(observer("timg0")).define("timg0", ["createImg","tensor0"], function(createImg,tensor0){return(
createImg(tensor0)
)});
  main.variable(observer("timg1")).define("timg1", ["createImg","tensor1"], function(createImg,tensor1){return(
createImg(tensor1)
)});
  main.variable(observer("timg2")).define("timg2", ["createImg","tensor2"], function(createImg,tensor2){return(
createImg(tensor2)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`## MobileNet Predictions`
)});
  main.variable(observer("predict0")).define("predict0", ["mobilenet","tensor0","topK"], async function(mobilenet,tensor0,topK){return(
await mobilenet.classify(tensor0,topK)
)});
  main.variable(observer("predict1")).define("predict1", ["mobilenet","tensor1","topK"], async function(mobilenet,tensor1,topK){return(
await mobilenet.classify(tensor1,topK)
)});
...
mn_predictions(predict0)
  ...
  main.variable(observer()).define(["mn_predictions","predict1"], function(mn_predictions,predict1){return(
...
md`## Tools`
  ...
  main.variable(observer("mobilenet")).define("mobilenet", ["mobilenetModule"], async function(mobilenetModule){return(
await mobilenetModule.load()
)});
  main.variable(observer("imagenetClasses")).define("imagenetClasses", function()
{
  return {
    '0': 'tench, Tinca tinca',
  ...
  main.variable(observer("imagenetClassIdx")).define("imagenetClassIdx", ["imagenetClasses"], function(imagenetClasses)
{
  const result={};
  ...
  main.variable(observer("mobilenetModule")).define("mobilenetModule", ["require"], async function(require){return(
await require('@tensorflow-models/mobilenet@0.2')
)});
  main.variable(observer("tf")).define("tf", ["require"], async function(require){return(
await require('@tensorflow/tfjs@1.0.0')
)});
